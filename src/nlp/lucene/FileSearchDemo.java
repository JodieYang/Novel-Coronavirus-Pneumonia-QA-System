...
import nlp.lucene.util.FileUtil;
/**
 * 
 * @author 69567
...
{
	public static final String INDEX_PATH = "D:\\NLP\\lucene"; // 存放Lucene索引文件的位置
	public static final String SCAN_PATH = "D:\\NLP\\text"; // 需要被扫描的位置，测试的时候记得多在这下面放一些文件
	...
	public void creatIndex()
	{
		...
		try
		{
			...
			//directory:存放目录的位置，indexWriterConfig:分词   
			...
			{
				//每个文件对应一个document，一个content中有多个field
	...
	public void search(String keyWord)
	{
		...
		try
		{
			...
			TopDocs topDocs = indexSearcher.search(multiFieldQuery, 20); // 搜索前100条结果
